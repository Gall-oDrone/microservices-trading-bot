...
|-------|-------------|--------|
| P0 | S3 catalog doc + news-publisher + research-agent scaffold + research K8s overlay | **This PR** |
| P1 | strategy-executor consumer for `news.agentic` (sentiment filter) | Next |
