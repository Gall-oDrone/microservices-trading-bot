...
resource "helm_release" "aws_load_balancer_controller" {
  ...
  set { name = "serviceAccount.annotations.eks.amazonaws.com/role-arn" value = module.iam_irsa.irsa_role_arns["alb"] }
}
...
resource "helm_release" "external_dns" {
  ...
  set { name = "txtOwnerId" value = local.name }
  set { name = "serviceAccount.create" value = true }
  set { name = "serviceAccount.annotations.eks.amazonaws.com/role-arn" value = module.iam_irsa.irsa_role_arns["external-dns"] }
}
...
resource "helm_release" "cert_manager" {
  ...
  set { name = "serviceAccount.create" value = true }
  set { name = "serviceAccount.annotations.eks.amazonaws.com/role-arn" value = module.iam_irsa.irsa_role_arns["cert-manager"] }
}
...
resource "helm_release" "external_secrets" {
  ...
  create_namespace = true
  set { name = "serviceAccount.create" value = true }
  set { name = "serviceAccount.annotations.eks.amazonaws.com/role-arn" value = module.iam_irsa.irsa_role_arns["external-secrets"] }
}
